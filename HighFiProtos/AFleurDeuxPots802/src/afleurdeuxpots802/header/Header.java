...
public class Header extends javax.swing.JPanel {
    ...
    public final static int COMMAND_CLICKED_SIGNAL = 5;
    ...
    public void goToCommand() {
        support.firePropertyChange(String.valueOf(COMMAND_CLICKED_SIGNAL), null, null);
    }
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        support.firePropertyChange(String.valueOf(CART_CLICKED_SIGNAL), null, null);
